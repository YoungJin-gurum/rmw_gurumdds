...
#ifndef RMW_GURUMDDS_SHARED_CPP__GID_HPP_
#define RMW_GURUMDDS_SHARED_CPP__GID_HPP_
...
{
  dds_GUID_t dds_guid;
  if (dds_Entity_get_guid(static_cast<dds_Entity *>(entity), &dds_guid) == dds_RETCODE_OK) {
    guid_to_gid(dds_guid, gid);
  }
}

#endif  // RMW_GURUMDDS_SHARED_CPP__GID_HPP_
